...
--
-- Gazdă: sql301.epizy.com
-- Timp de generare: iun. 30, 2020 la 04:18 AM
...
(1, 'admin', 'catalincostin995@gmail.com', 'm1X8Zi0Mna.png', '$2y$10$ffGvkWjFYqe1l8d.Bxvqp.nnCb/aR3i/Xc43zxQBRsrakBnm/tGRi', 1, 'Catalin', 'Costin', '', '', 'Student', 'Romania', 'Maramures', 'Baia Mare', '', '1593238400'),
...
(14, '', '', '', '', 2, '', '', '', '', '', '', '', '', '', '1593362556'),
(15, '', '', '', '', 2, '', '', '', '', '', '', '', '', '', '1593365812'),
(16, 'CostinCatalin', 'catalincostin@yahoo.com', 'WsPa7qIJxY.jpg', '$2y$10$ffGvkWjFYqe1l8d.Bxvqp.nnCb/aR3i/Xc43zxQBRsrakBnm/tGRi', 1, 'Catalin', 'Costin', '', '', 'Student', 'Romania', 'Maramures', 'Baia Mare', '', '1593374444'),
(21, '', '', '', '', 2, '', '', '', '', '', '', '', '', '', '1593498522'),
...
(151, 23, 27, 104, '0', '1593499551'),
(152, 23, 27, 105, '0', '1593499551'),
(153, 23, 27, 106, '0', '1593499551'),
(154, 23, 27, 107, '0', '1593499551'),
(155, 23, 27, 108, '0', '1593499551');
...
--
ALTER TABLE `qz_questions`
  MODIFY `question_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT pentru tabele `qz_quizzes`
--
ALTER TABLE `qz_quizzes`
  MODIFY `quiz_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `qz_user_answers`
  MODIFY `us_answer_id` int(24) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
COMMIT;
